...
var (
	...
	customInformationResolvers []func()
	getGoVersion               = runtime.Version
)

func NewAboutCommand(app foundation.Application) *AboutCommand {
	return &AboutCommand{app: app}
}

func (r *AboutCommand) Signature() string { return "about" }
...
func (r *AboutCommand) gatherApplicationInformation() {
	...
	appInformation.addToSection("Environment", []foundation.AboutItem{
		...
		{Key: "AiGoAgent Version", Value: strings.TrimPrefix(r.app.Version(), "v")},
